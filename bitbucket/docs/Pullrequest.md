...
**Rendered** | **interface{}** | User provided pull request text, interpreted in a markup language and rendered in HTML | [optional] [default to null]
...
**MergeCommit** | **interface{}** |  | [optional] [default to null]
