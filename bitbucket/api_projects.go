...
@return Project
*/
func (a *ProjectsApiService) TeamsUsernameProjectsProjectKeyPut(ctx context.Context, projectKey string, username string, body Project) (Project, *http.Response, error) {
	var (
