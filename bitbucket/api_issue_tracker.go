...
*/
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdDelete(ctx context.Context, commentId int32, issueId string, repoSlug string, workspace string, body IssueComment) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
