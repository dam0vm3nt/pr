...
@return Snippet
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommentsPost(ctx context.Context, encodedId string, workspace string, body Snippet) (Snippet, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
